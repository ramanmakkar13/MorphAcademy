<?php
 ...
 $to = "ramanmakkar612@gmail.com";
 $subject = $_POST['email'];
 $message =  "<table><tr><td>Name:".$_POST['name']."</td></tr><tr><td>Email: ".$_POST['email']."</td></tr><tr><td>phone: ".$_POST['phone']."</td></tr>
 <td><td>campus: ".$_POST['campus']."</td><td>state: ".$_POST['state']."</td></td>subject" .$_POST['subject']."</td></tr>
 
 </table>";
 $from= $_POST['email'];

$headers = "Content-type: text/html; charset=iso-8859-1,From:".$from."\r\n" ;
//  "CC: accounting@example.com";
 $retval=mail($to,$subject,$message,$headers);
    
        if( $retval == true ) {
          
          header("location:https://freetheme.in/fashion/");
